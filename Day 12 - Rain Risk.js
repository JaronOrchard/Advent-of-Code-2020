...
function day12(input) {
  var facing = 0; // 0 = East, 1 = South, 2 = West, 3 = North
  var x = 0;
  var y = 0;
  for (var i = 0; i < input.length; i++) {
    var amount = Number(input[i].substr(1));
    if (input[i][0] === "F") {
      if (facing === 0) {
        x += amount;
      } else if (facing === 1) {
    ...
    console.log("After " + input[i] + ": x=" + x + ", y=" + y + ", facing=" + facing);
  }
  console.log(x + "," + y);
}
